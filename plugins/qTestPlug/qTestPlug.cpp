...
qTestPlug::qTestPlug( QObject *parent )
	: QObject( parent )
...
void qTestPlug::onNewSelection( const ccHObject::Container &selectedEntities )
{
	if ( m_action == nullptr )
	{
		return;
...
QList<QAction *> qTestPlug::getActions()
{
