...
static const unsigned char qt_pluginMetaData[] = {
    ...
    'h',  0x03, 0x00, 0x00, 0x1b, 0x03, 0x00, 0x00,
    0x03, 0x00, 'I',  'I',  'D',  0x00, 0x00, 0x00,
    '$',  0x00, 'c',  'c',  'c',  'o',  'r',  'p', 
    '.',  'c',  'l',  'o',  'u',  'd',  'c',  'o', 
    'm',  'p',  'a',  'r',  'e',  '.',  'p',  'l', 
    'u',  'g',  'i',  'n',  '.',  'c',  'c',  'C', 
    'o',  'm',  'p',  'a',  's',  's',  0x00, 0x00,
    0x1b, 0x0a, 0x00, 0x00, 0x09, 0x00, 'c',  'l', 
    'a',  's',  's',  'N',  'a',  'm',  'e',  0x00,
    0x09, 0x00, 'c',  'c',  'C',  'o',  'm',  'p', 
    'a',  's',  's',  0x00, ':',  '@',  0xa1, 0x00,
    0x07, 0x00, 'v',  'e',  'r',  's',  'i',  'o', 
    'n',  0x00, 0x00, 0x00, 0x11, 0x00, 0x00, 0x00,
    0x05, 0x00, 'd',  'e',  'b',  'u',  'g',  0x00,
    0x15, 0x11, 0x00, 0x00, 0x08, 0x00, 'M',  'e', 
    't',  'a',  'D',  'a',  't',  'a',  0x00, 0x00,
    0xe0, 0x02, 0x00, 0x00, 0x11, 0x00, 0x00, 0x00,
    0xc0, 0x02, 0x00, 0x00, 0x1b, 0x03, 0x00, 0x00,
    ...
    'm',  'e',  0x00, 0x00, 0x07, 0x00, 'C',  'o', 
    'm',  'p',  'a',  's',  's',  0x00, 0x00, 0x00,
    0x9b, 0x0a, 0x00, 0x00, 0x04, 0x00, 'i',  'c', 
    'o',  'n',  0x00, 0x00, '$',  0x00, ':',  '/', 
    'C',  'C',  '/',  'p',  'l',  'u',  'g',  'i', 
    'n',  '/',  'q',  'C',  'o',  'm',  'p',  'a', 
    's',  's',  '/',  'i',  'm',  'a',  'g',  'e', 
    's',  '/',  'i',  'c',  'o',  'n',  '.',  'p', 
    'n',  'g',  0x00, 0x00, 0x1b, 0x12, 0x00, 0x00,
    ...
    'f',  'e',  'r',  'e',  'n',  'c',  'e',  's', 
    'P',  0x01, 0x00, 0x00, 0x04, 0x00, 0x00, 0x00,
    'H',  0x01, 0x00, 0x00, 0xb8, 0x00, 0x00, 0x00,
    0x05, 0x00, 0x00, 0x00, 0xb0, 0x00, 0x00, 0x00,
    0x1b, 0x03, 0x00, 0x00, 0x04, 0x00, 't',  'e', 
    'x',  't',  0x00, 0x00, '`',  0x00, 'R',  'a', 
    'p',  'i',  'd',  ',',  ' ',  's',  'e',  'm', 
    'i',  '-',  'a',  'u',  't',  'o',  'm',  'a', 
    't',  'i',  'c',  ' ',  'f',  'r',  'a',  'c', 
    't',  'u',  'r',  'e',  ' ',  'a',  'n',  'd', 
    ...
    'o',  'p',  'h',  'y',  's',  'i',  'c',  'a', 
    'l',  ' ',  'd',  'a',  't',  'a',  0x00, 0x00,
    0x1b, 0x11, 0x00, 0x00, 0x03, 0x00, 'u',  'r', 
    'l',  0x00, 0x00, 0x00, '&',  0x00, 'h',  't', 
    't',  'p',  's',  ':',  '/',  '/',  'd',  'o', 
    'i',  '.',  'o',  'r',  'g',  '/',  '1',  '0', 
    '.',  '5',  '1',  '9',  '4',  '/',  's',  'e', 
    '-',  '8',  '-',  '1',  '2',  '4',  '1',  '-', 
    '2',  '0',  '1',  '7',  0x0c, 0x00, 0x00, 0x00,
    ...
    0x85, 0x01, 0x00, 0x00, 0x85, 0x18, 0x00, 0x00,
    0xcc, 0x00, 0x00, 0x00, '$',  0x00, 0x00, 0x00,
    '|',  0x00, 0x00, 0x00, 'H',  0x00, 0x00, 0x00,
    0x14, 0x01, 0x00, 0x00, '0',  0x00, 0x00, 0x00,
...
static const unsigned char qt_pluginMetaData[] = {
    ...
    0x14, 0x01, 0x00, 0x00, '0',  0x00, 0x00, 0x00,
    '`',  0x01, 0x00, 0x00, 0x0c, 0x00, 0x00, 0x00,
    0x1b, 'h',  0x00, 0x00, 0x09, 0x00, 'c',  'l', 
    'a',  's',  's',  'N',  'a',  'm',  'e',  0x00,
    0x09, 0x00, 'c',  'c',  'C',  'o',  'm',  'p', 
    'a',  's',  's',  0x00, '1',  0x00, 0x00, 0x00,
    0x05, 0x00, 'd',  'e',  'b',  'u',  'g',  0x00,
    ':',  '@',  0xa1, 0x00, 0x07, 0x00, 'v',  'e', 
    'r',  's',  'i',  'o',  'n',  0x00, 0x00, 0x00,
    0x0c, 0x00, 0x00, 0x00, '@',  0x00, 0x00, 0x00,
    '0',  0x03, 0x00, 0x00, 'L',  0x03, 0x00, 0x00,
    'X',  0x03, 0x00, 0x00
};
#endif // QT_NO_DEBUG
